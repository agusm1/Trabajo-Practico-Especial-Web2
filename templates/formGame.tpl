...
<div class="container">
    <form action="createGame" method="POST" class="col-md-4 offset-md-4 mt-4">
        ...
        <div class="form-group">
            ...
            <input name="sinopsis" type="text" class="form-control" placeholder="Ingrese la sinopsis del genero">
        </div>
        <div class="form-group">
            <select name="genero">
